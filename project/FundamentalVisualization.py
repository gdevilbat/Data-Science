...
def tugasMiniProject(request):
    # Menampilkan Komparasi Frekuensi 2 Variabel
    ...
    plt.tight_layout(rect=(0,0,1.01,0.90))

    produktivitas = getGraph()

    return HttpResponse("<img src='data:image/png;base64, "+umur+"' />"+"<br/>"+"<img src='data:image/png;base64, "+produktivitas+"' />")
